...
var
  sSQL2: String;
begin
  sSQL2 := 'Select Surname from tblEmployees where Permanent like true';
...
var
  sSQL3: String;
begin
  sSQL3 := 'Select PaymentNumber from tblPayments where PaymentDate = #2017/01/12# ';
...
var
  sSQL5: String;
begin
  sSQL5 := 'Select month(PaymentDate), Sum(GrossSalary) from tblPayments group by Month(PaymentDate)';
...
begin
 ...
 tblPayments.First;
  while not tblPayments.Eof do
  begin
  redQ2.Lines.Add(tblPayments['Deductions']);
  tblPayments.Next;
  end;
